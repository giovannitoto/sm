...
```{r}
bi_M5S <- tw[tw$partito == "M5S",] %>% unnest_ngrams(word,tweet,n=2) %>% group_by(word) %>%
  summarise(tot=n()) %>% arrange(desc(tot)) %>% print(n = 80)
```
...
mono_LSP <- tw[tw$partito == "LSP",] %>% unnest_tokens(word,tweet) %>% 
  group_by(word) %>% summarise(tot=n()) %>% arrange(desc(tot)) %>% print(n = 80)
```
...
```{r}
bi_LSP <- tw[tw$partito == "LSP",] %>% unnest_ngrams(word,tweet,n=2) %>% group_by(word) %>% 
  summarise(tot=n()) %>% arrange(desc(tot)) %>% print(n = 80)
```
...
```{r}
bi_PD <- tw[tw$partito == "PD",] %>% unnest_ngrams(word,tweet,n=2) %>% group_by(word) %>%
  summarise(tot=n()) %>% arrange(desc(tot)) %>% print(n = 80)
```
...
```{r}
bi_FI <- tw[tw$partito == "FI",] %>% unnest_ngrams(word,tweet,n=2) %>% group_by(word) %>% 
  summarise(tot=n()) %>% arrange(desc(tot)) %>% print(n = 80)
```
...
```{r}
bi_FdI <- tw[tw$partito == "FdI",] %>% unnest_ngrams(word,tweet,n=2) %>% group_by(word) %>%
  summarise(tot=n()) %>% arrange(desc(tot)) %>% print(n = 80)
```
...
```{r}
bi_IV <- tw[tw$partito == "IV",] %>% unnest_ngrams(word,tweet,n=2) %>% group_by(word) %>% 
  summarise(tot=n()) %>% arrange(desc(tot)) %>% print(n = 80)
```
